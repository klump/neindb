...
class ChecksControllerTest < ActionController::TestCase
  ...
  test "should create check" do
    assert_difference('Check.count') do
      post :create, check: { data: @check.data, message: @check.message, name: @check.name, status: @check.status }
    end
  ...
  test "should update check" do
    patch :update, id: @check, check: { data: @check.data, message: @check.message, name: @check.name, status: @check.status }
    assert_redirected_to check_path(assigns(:check))
  end
